...
def Rydberg_pop(omega_c, delta_c, omega_p, spontaneous_32, spontaneous_21, lw_probe, lw_coupling, dmin, dmax, steps, gauss, temperature, kp, kc, beamdiv, probe_diameter, coupling_diameter, tt):
...
def bisection(a, b, delta_c, omega_p, spontaneous_32, spontaneous_21, lw_probe, lw_coupling, dmin, dmax, steps, gauss, temperature, kp, kc, beamdiv, probe_diameter, coupling_diameter, tt):
    """
    ...
    """
    while b-a > 1e3:        
        f_a = Rydberg_pop(a, delta_c, omega_p, spontaneous_32, spontaneous_21, lw_probe, lw_coupling, dmin, dmax, steps, gauss, temperature, kp, kc, beamdiv, probe_diameter, coupling_diameter, tt)
        f_b = Rydberg_pop(b, delta_c, omega_p, spontaneous_32, spontaneous_21, lw_probe, lw_coupling, dmin, dmax, steps, gauss, temperature, kp, kc, beamdiv, probe_diameter, coupling_diameter, tt)
        m = (a+b)/2 # midpoint calculation
        f_m = Rydberg_pop(m, delta_c, omega_p, spontaneous_32, spontaneous_21, lw_probe, lw_coupling, dmin, dmax, steps, gauss, temperature, kp, kc, beamdiv, probe_diameter, coupling_diameter, tt)
        r = (m+b)/2
        f_r = Rydberg_pop(r, delta_c, omega_p, spontaneous_32, spontaneous_21, lw_probe, lw_coupling, dmin, dmax, steps, gauss, temperature, kp, kc, beamdiv, probe_diameter, coupling_diameter, tt)
        l = (m+a)/2
        f_l = Rydberg_pop(l, delta_c, omega_p, spontaneous_32, spontaneous_21, lw_probe, lw_coupling, dmin, dmax, steps, gauss, temperature, kp, kc, beamdiv, probe_diameter, coupling_diameter, tt)
...
if __name__ == "__main__":
    ...
    result = bisection(1e6, 40e6, 0, 10e6, 4e4, 32e6*2*np.pi, 1e5, 1e5, -100e6, 100e6, 1000, "N", 623.15, 2*np.pi/461e-9, 2*np.pi/461e-9, 38e-3, 1, 1, "N")
    print(result)
    ray.shutdown()
