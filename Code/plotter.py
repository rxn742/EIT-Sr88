...
#gamma_ig = 2*np.pi*30e6*0.99995 # Spontaneous emission rate from i to g
#kp = 2*np.pi/461e-9 # Probe wavevector in m^-1
#kc = 2*np.pi/413e-9 # Coupling wavevector in m^-1
#Omega_c = 2*np.pi*2.9e6 # Coupling Rabi frequency
#Omega_p = 2*np.pi*12.1e6 # Probe Rabi frequency
#density = 2e14 # Number density of atoms in m^-3
#lwc = 1e6 # Coupling laser linewidth in Hz
#lwp = 1e6 # Probe laser linewidth in Hz
